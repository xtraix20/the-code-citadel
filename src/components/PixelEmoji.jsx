...
const emojiMap = {
  "🏰": (
    <svg viewBox="0 0 12 12" className="w-full h-full inline-block align-middle" style={{ imageRendering: 'pixelated' }}>
  ...
  "🪙": (
    <svg viewBox="0 0 10 10" className="w-full h-full inline-block align-middle" style={{ imageRendering: 'pixelated' }}>
